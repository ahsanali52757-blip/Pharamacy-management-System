...
<body>
    ...
    if(isset($_POST['add']))
    {
        ...
        // Validate inputs
        if(empty($name) || empty($qty) || empty($sprice)) {
            echo "<p style='font-size:8; color:red;'>Error! Name, Quantity and Price are required.</p>";
        } else {
            ...
            if(mysqli_query($conn, $sql)){
                echo "<p style='font-size:8; color:green;'>Medicine details successfully added!</p>";
            } else {
                echo "<p style='font-size:8; color:red;'>Error: " . mysqli_error($conn) . "</p>";
            }
        }
    }
